...
public class character_jump_V1 extends Sprite_V1
{
    ...
    public character_jump_V1(int height) {
    ...
    public void move()
    {
        ...
        else if(dx == 0 && y == floorHeight)
        {
            ...
            else if(lastDirection == 2) loadImage("res/character/crouch/adventurer-crouch-00.png");
        }
    }
